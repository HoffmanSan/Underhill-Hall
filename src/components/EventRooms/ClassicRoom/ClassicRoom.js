      ...
      <div className="legend">
        ...
        <ul>
          <li className="legend-item">
            <img src={UntakenSeatIcon} height="79px" width="62px" alt="Untaken Seat Icon" />
            <p>Open</p>
          </li>
          <li className="legend-item">
            <img src={TakenSeatIcon} height="79px" width="62px" alt="Untaken Seat Icon" />
            <p>Taken</p>
          </li>
          <li className="legend-item">
            <img src={PickedSeatIcon} height="79px" width="62px" alt="Picked Seat Icon" />
            <p>Picked</p>
          </li>
        </ul>
      </div>
